...
# Test script for the b402 AI Agent

PORT=${PORT:-3000}
HOST="http://localhost:${PORT}"

echo "🧪 Testing b402 AI Agent"
echo ""
...
echo "✅ Test complete!"
echo ""
echo "Expected: 402 Payment Required response with b402 payment details"
echo "To complete the payment, you need to use a b402-compatible client"
